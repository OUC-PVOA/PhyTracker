...
class _DataParallel(Module):
    ...
    Example::
        ...
        >>> net = torch.nn.parallel.DistributedDataParallel(model, device_ids=[local_rank], output_device=local_rank)
...
def DataParallel(module, device_ids=None, output_device=None, dim=0, chunk_sizes=None):
    if chunk_sizes is None:
        ...
        return torch.nn.parallel.DistributedDataParallel(module, device_ids, output_device, dim)
    standard_size = True
